...
#'@param inchikeys a vector of InChIKeys that will be be classified. Only one of the
#'parameters file, inchikeys, smiles or inchis should be provided.
#'@param smiles a vector of SMILES that will be classified. Only one of the
#'parameters file, inchikeys, smiles or inchis should be provided.
#'@param inchis a vector of InChIs that will be converted. Only one of the
#'parameters file, inchikeys, smiles or inchis should be provided.
...
gsmn_to_ontology <- function(file=NULL,
  ...
  if(!is.null(smiles)){
    ...
    network_tibble <- new_tibble(data.frame(ID=smiles))
  ...
  if(!is.null(inchis)){
    ...
    network_tibble <- new_tibble(data.frame(ID=inchis))
  ...
  if(!is.null(inchikeys)){
    network_tibble <- new_tibble(data.frame(ID=inchikeys,
                                            Identifiers.inchikey=inchikeys))
  }
