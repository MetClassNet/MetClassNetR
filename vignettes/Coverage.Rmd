...
```{r, message=FALSE}
## Input
source_folder <- "../data/example_coverage/"

network_file <-  file.path(paste0(source_folder,"iHY3410_Compound-SBtab.tsv"))
data_file <- file.path(paste0(source_folder,"example_smiles.csv"))

chemont_obofile <- file.path(paste0(source_folder,"ChemOnt_2_1.obo"))
```
...
```{r}
data_tibble <- as_tibble(data.frame(smiles = read.csv(paste0(source_folder,"example_smiles.csv"), 
...
```{r, message=FALSE}
load(paste0(source_folder,"network_tibble.Rdata"))
```
...
load(paste0(source_folder,"data_tibble.Rdata"))
```
...
# ggsave(filename = paste0(source_folder,"fig_example_chemont_coverage_circleplot.pdf"))
```
...
# ggsave(filename = paste0(source_folder,"fig_example_chemont_coverage_sunburst.pdf"))
```
...
# ggsave(filename = paste0(source_folder,"fig_example_chemont_coverage_tree.pdf"))
```
...
ggsave(plot=p,
       filename=paste0(source_folder,"fig_example_chemont_coverage_partitionstack_labelled.pdf"),
