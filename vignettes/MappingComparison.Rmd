...
## Map by ID
```{r mapping}
inputData <- annotateChemicalPropertiesToExperiment(inputData)

# getChemicalPropertiesFromChebi(fileIn = inputData$metF, fileOut=paste0(inputData$resPath,"GSMN_properties.tsv"))
# mapMetToGSMN(inputData, method="id_inchikey", gsmnMetaFile=paste0(inputData$resPath,"GSMN_properties.tsv") )
