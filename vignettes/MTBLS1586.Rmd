...
<!-- # check if MS1 and MS2 share the same ID namespace -->
<!-- # positive ionization -->
<!-- checkIdNamespace(mtbls1586_qf_neg, ms2_spectra_neg) -->
<!-- checkIdNamespace(mtbls1586_qf_pos, ms2_spectra_pos) -->
<!-- ``` -->

MS2 spectra can be filled with empty spectra to have a complete list of spectra for all the features
...
exportNet2gml(x = pears_l,file = "pears")



# Create and export attribute file 
atributes <- merge(pears_p_l, massdiff_l, by = c("Var1", "Var2"))
...
exportAttributes2gml(atributes, file = "attributes_mtbls1586_pos", names = feat_names)
